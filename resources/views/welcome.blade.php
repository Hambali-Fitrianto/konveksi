...
@section('content')
        ...
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-md-6 wow fadeInLeft" data-wow-duration="1s">
                    ...
                    <p class="lead animated fadeInUp">Solusi Konveksi Berkualitas dengan Harga Terjangkau.</p>
                    <a href="{{ route('login') }}" class="btn btn-primary btn-lg animated fadeInUp" data-wow-delay="0.3s">Masuk ke Akun</a>
                    <a href="{{ route('register') }}" class="btn btn-outline-light btn-lg ms-3 animated fadeInUp" data-wow-delay="0.6s">Daftar Sekarang</a>
                </div>
                <div class="col-md-6 wow fadeInRight" data-wow-duration="1s">
                    <img src="https://via.placeholder.com/500x400.png?text=Konveksi+Image" class="img-fluid rounded shadow-lg animated fadeInRight" alt="Konveksi Image">
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="services" class="services py-5 bg-light">
        <div class="container">
            ...
            <div class="row">
                <!-- Pakaian Kerja -->
                <div class="col-md-4 mb-4 wow zoomIn" data-wow-duration="1s" data-wow-delay="0.3s">
                ...
                <!-- Kaos Promosi -->
                <div class="col-md-4 mb-4 wow zoomIn" data-wow-duration="1s" data-wow-delay="0.6s">
                    <div class="card shadow border-light">
                ...
                <!-- Custom Merchandise -->
                <div class="col-md-4 mb-4 wow zoomIn" data-wow-duration="1s" data-wow-delay="0.9s">
                    <div class="card shadow border-light">
    ...
    <section id="contact" class="contact py-5 text-white bg-dark">
        <div class="container text-center">
            ...
            <p class="lead wow fadeInUp" data-wow-duration="1s">Jika Anda memiliki pertanyaan atau ingin memesan produk, silakan hubungi kami sekarang!</p>
            <a href="mailto:contact@konveksi.com" class="btn btn-primary btn-lg wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">Email Kami</a>
        </div>
    </section>
